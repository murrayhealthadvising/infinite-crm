        ...
        <div style={{ background: '#080B0F', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', padding: 40 }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={this.reset} style={{ padding: '8px 16px', borderRadius: 0, background: '#1A2130', color: 'white', border: '1px solid #2A3547', fontSize: 13, cursor: 'pointer' }}>Try again</button>
              <button onClick={this.reload} style={{ padding: '8px 16px', borderRadius: 0, background: 'linear-gradient(135deg, #00E5C3, #3B82F6)', color: 'black', border: 'none', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>Reload page</button>
            </div>
          </div>
        </div>
      )
    ...
    return (
      <div style={{ background: '#080B0F', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
          <div style={{ width: 40, height: 40, borderRadius: 0, background: 'linear-gradient(135deg, #00E5C3, #3B82F6)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
