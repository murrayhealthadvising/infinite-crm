...
//
// Click the bookmark on any PitchPerfect contact panel → an overlay pops up
// with the contact's info prefilled. Verify/edit, hit Send to CRM, get a
...
;(function () {
  ...
  function showToast(msg) {
    var t = el('div', { style: {
      ...
      zIndex: '2147483647',
      background: '#0E1318', color: '#00E5C3', padding: '12px 18px',
      borderRadius: '999px', border: '1px solid #00E5C340',
